    ...
    return {
        ...
        execute: function() {
            ScheduleService = (function () {
                ...
                ScheduleService.prototype.find = function (schedule_id) {
                    return this.http.get('schedule/search/' + schedule_id);
                };
                ScheduleService.prototype.bind = function (schedule_id, user_id) {
                    return this.http.get('schedule/bind?id=' + schedule_id + '&user_id=' + user_id);
                };
                ScheduleService.prototype.unlink = function (schedule_id, user_id) {
                    return this.http.get('schedule/unlink?id=' + schedule_id + '&user_id=' + user_id);
                };
                ScheduleService.prototype.getList = function (course_id) {
